...
<!--
Define styling of exercise and homework sections (unnumbered headers)
-->
...
<!--
TODO: 
+ Update exercises & homework. Especially from 5.5. Merging onwards
+ Update Statistical Modelling part. How much methodology should be in there?
+ Update Loops and Functions part. include apply. include if else statements.
  Should this section come earlier?
+ Update Workflow part. Especially integration with word should be illustrated
  because it is a big hurdle for most people. 
+ Develop part on web-scraping and quantitative text analysis
+ Develop part on shiny
+ Develop part on graphs/ggplot2
+ Develop part on maxQDA/NViVo alternatives (RQDA?)
-->
...
<div align = left>
_Acknowledgement: This course builds upon a script designed by Paul C. Bauer, who himself was inspired by Rudolf Farys. Likewise, you can freely use the Markdown file to adopt this script to your teaching needs. Please find the R Markdown and all other necessary files in the GitHub repository linked below. (script-v.0.7-2017-11-28) _ 

<a href="https://github.com/pwangen/Intro-Data-Analysis-with-R">
<img src = "img/github.png" width = 25px></a>
<img src = "img/cc.png" width = 25px>
<img src = "img/cc_by.png" width = 25px>
...
# Remove these files again to keep folders clean of nonsense.
file.remove("myObject.RData")
file.remove("myEnvironment.RData")
```
